  ...
  return (
    ...
    <div className="p-4">
      ...
      {categories.map((category, index) => (
          ...
          <input type="checkbox" id="javascriptCheckbox" name="languageCheckbox" className="h-4 w-4 rounded border-gray-300 text-teal-600 shadow-sm focus:border-teal-300 focus:ring focus:ring-teal-200 focus:ring-opacity-50 focus:ring-offset-0 disabled:cursor-not-allowed disabled:text-gray-400" />
          <label for="javascriptCheckbox" className="flex w-full space-x-2 text-sm"> {category.category} </label>
        </div>
      )
      )}
    </div>
