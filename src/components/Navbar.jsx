...
const Navbar = () => {
  ...
  // useEffect(() => {
  //   const saveDarkmode = localStorage.getItem('darkMode') === 'ture';
  ...
  return (
    <>
      <nav className="border-gray-200 lavender dark:bg-gray-900 delay-50 duration-500">
        ...
        class="h-12 w-12 rounded-lg p-2 dark:hover:bg-gray-700">
